...
function getZSharpGrammar(getVariables: (grammarVariables: MapLike<string>) => MapLike<string>) {
    const grammarBeforeTransformation = readYaml(inputFile(Language.ZSharp, Extension.YamlTmLanguage)) as TmGrammar;
